...
function doBusinessAction(vorbanf) {
    ...
    if (checklistSearch.getHitCount() == 0) {
       ...
       /**
         * TODo check if Banf-Items is == 0 Do not allow to generate checklist.And display message No Banf-Items found
         */
    ...
    /**
     *  Search.findAllPages() will return all records which satisfies the condition( CHECKLIST_SET.ATTR.IS_ACTIVE should be true);
